...
import algorithms.lppm.AlgoLPPMDepth2_Parallel;
import tools.MemoryLogger;

/**
 * Experiment Class: LPPM-Depth Algorithm PARALLEL VERSION
 *
 * This wrapper runs the LPPM-Depth PARALLEL solution.
 * Uses ExecutorService to parallelize at Level 1 (root level).
 * Each frequent item at level 1 is processed independently by a thread.
 *
...
public class ExperimentLPPMDepth_Parallel {
    ...
    public ExperimentResult run() throws IOException {
        ...
        printHeader("LPPM-Depth PARALLEL", label, outputFile);
        ...
        try {
            ...
            AlgoLPPMDepth2_Parallel algo = new AlgoLPPMDepth2_Parallel(numThreads);
            ...
            ExperimentResult result = new ExperimentResult(
                "LPPM-Depth-Parallel-" + numThreads + "T", datasetName, maxPer, minDur, maxSoPer,
    ...
    private void writeOomStats(String statsFile, ExperimentResult r) throws IOException {
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(statsFile))) {
            bw.write("=== LPPM-Depth PARALLEL - Experiment Stats ===\n");
            ...
            bw.write("Note: LPPM-Depth PARALLEL ran out of memory indexing the initial Database Vectors.\n");
        }
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        ExperimentLPPMDepth_Parallel exp = new ExperimentLPPMDepth_Parallel(
