...
import algorithms.lppm.AlgoLPPMBreadth_Parallel;
import tools.MemoryLogger;

/**
 * Experiment wrapper cho AlgoLPPMBreadth_Parallel.
 * Giống ExperimentLPPMBreadth nhưng dùng parallel algorithm.
 */
public class ExperimentLPPMBreadth_Parallel {
    ...
    public ExperimentResult run() throws IOException {
        ...
        System.out.println("\n========================================================");
        System.out.printf ("  EXPERIMENT: LPPM-Breadth PARALLEL (%d threads)%n", numThreads);
        System.out.println("========================================================");
        ...
        try {
            AlgoLPPMBreadth_Parallel algo = new AlgoLPPMBreadth_Parallel(numThreads);
            ...
            ExperimentResult result = new ExperimentResult(
                "LPPM-Breadth-Parallel", datasetName, maxPer, minDur, maxSoPer,
            ...
            System.err.printf("  WARNING: OOM! '%s' too large for LPPM-Breadth-Parallel%n", datasetName);
